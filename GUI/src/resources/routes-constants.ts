...
export const ROUTES = {
  ...
  CLIENTS_CREATE_EDIT_ROUTE: '/centops/clients/:clientId?',
  CLIENTS_SECRETS_ROUTE: '/centops/clients/:clientId/secrets',
  CLIENTS_SECRETS_EDIT_ROUTE: '/centops/clients/:clientId/secrets/:secretId?',
