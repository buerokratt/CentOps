...
if [ -d "TechStack/TIM" ]; then
    ...
    sed -i '' 's/security.allowlist.jwt=127.0.0.1,::1/security.allowlist.jwt=ruuter,resql,resql-users,database,data_mapper,tim,tim-postgresql,gui_dev_private,gui_dev_public,127.0.0.1,::1/' TechStack/TIM/src/main/resources/application.properties
